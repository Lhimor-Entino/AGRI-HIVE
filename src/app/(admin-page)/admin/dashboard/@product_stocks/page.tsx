    ...
    <div className=" w-full bg-teal-50 rounded-sm p-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex">
          <select className="text-xs text-teal-800 p-1 border border-1 border-gray-200 rounded">
            {years.map((mth, index) => (
              <option className="text-xs text-teal-900">{mth}</option>
            ))}
          </select>
        </div>
      </div>
      <div className="grid grid-cols-5 gap-1 mt-2">
        {stocks_colors.map((sc, index) => (
          <div className={`flex items-center min-w-3 justify-evenly `}>
            <span
      ...
      <div className="mt-5 flex justify-between items-center">
        ...
        <div className=" w-52 flex justify-between">
          {months.map((mt, index) => (
            <Tooltip title={mt} content={<p className="text-xs">{mt}</p>}>
              <p
                style={{ fontSize: ".4rem" }}
